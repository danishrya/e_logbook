...
<div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
    ...
    <div class="border-blue-600 border-4 rounded-lg shadow h-fit flex flex-col justify-between col-span-1 md:col-span-1 hidden md:block">
        ...
        <img class="rounded-2xl w-5/6 h-48 text-center mx-auto" src="../assets/images/maling.png" alt="" />
        <div class="p-5">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-600">ADA MALING HARAP HATI-HATI!!!!</h5>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">ada maling di jalan kenanga2 jika anda melihat yg mencurigakan segera laporkan.</p>
