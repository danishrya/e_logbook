<div class="antialiased">
    <!-- Navbar -->
    <nav class=" px-4 py-3 fixed left-0 right-0 top-0 z-50 bg-orange-300 ">
        <div class="flex flex-wrap justify-between items-center ">
            <div class="flex justify-start items-center">
                ...
                <a href="/" class="flex items-center justify-between mr-4  ">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap">keluh <span class="text-green-800 font-bold">kesah</span></span>
                </a>

                <!-- Tab Name -->
                <h4 class="hidden lg:block lg:text-2xl font-bold text-primary ml-5 text-red-500 "><?= ucwords($_GET['page']) ?></h4>
            ...
            <div class="flex items-center gap-3 lg:order-2">
                ...
                ?>
                    <a href="index.php?page=create" type="button" class="group inline-flex items-center px-4 py-2 text-sm font-medium text-blue-900 bg-transparent border border-blue-600 rounded hover:bg-blue-600 hover:text-white focus:z-10 focus:ring-2 bg-black ">
                        <svg class="w-4 h-4 mr-2 text-blue-900 group-hover:text-white" aria-hidden="true" xmlns="../assets/images/logo.png" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <div>
                        <a href="#" class="flex py-3 px-4 border-b border-gray-300 hover:bg-bgLight">
                            <div class="flex-shrink-0">
                                <img class="w-11 h-11 rounded-full object-cover" src="../assets/images/logo.png" alt="Rubel Islam" />
                            </div>
                            <div class="pl-3 w-full">
                                <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                                    New message from
                                    <span class="font-semibold text-gray">Mulia't Harosan</span>: "Create a new class text for class 10."
                                </div>
                ...
                <button type="button" class="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-blue-200" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                    ...
                    <img class="w-8 h-8 rounded-full object-cover" src="../assets/images/logo.png" alt="user photo" />
                </button>
                <!-- Dropdown menu -->
